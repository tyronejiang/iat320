...
This paragraph must be included in any redi:  stribution.
*/
...
//  if(height > peak)     peak   = height; // Keep 'peak' dot at top
  ...
  for(i=0; i<N_PIXELS; i++) {
    ...
    strip2.setPixelColor(i,   0,   0, 0);
      ...
      strip.setPixelColor(i,Wheel(map(i,0,strip.numPixels()-1,50,100)));
      strip2.setPixelColor(i,Wheel2(map(i,0,strip2.numPixels()-1,50,100)));
    }    
  }

  // Draw peak dot  （）
//  if(peak > 0 && peak <= N_PIXELS-1) {
//    strip.setPixelColor(peak,Wheel(map(peak,0,strip.numPixels()-1,0,0)));
//    strip2.setPixelColor(peak,Wheel2(map(peak,0,strip2.numPixels()-1,100,110)));
//  }
...
uint32_t Wheel(byte WheelPos) {
  if(WheelPos < 85) {
    ...
    //strip2.Color(WheelPos * 3, 255 - WheelPos * 3, 0);
    //return;
   ...
   WheelPos -= 85;
    ...
    //strip2.Color(255 - WheelPos * 3, 0, WheelPos * 3);
    //return;
    
  } else {
   WheelPos -= 170;
   return strip.Color(0, WheelPos * 3, 255 - WheelPos * 3);
   //strip2.Color(0, WheelPos * 3, 255 - WheelPos * 3);
   //return;
